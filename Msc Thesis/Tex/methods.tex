...
\begin{figure}[h!]
\centering
\subfloat{\includegraphics[width=4cm]{../Images/rawvmi1.PNG} \includegraphics[width=4cm]{../Images/rawvmi2.PNG}} 
...
\begin{figure}[hbtp!]
\centering
\subfloat{\includegraphics[width=0.4\textwidth]{../Images/rawVMIfit.PNG} \includegraphics[width=0.5\textwidth]{../Images/pesandFinder.PNG}} 
